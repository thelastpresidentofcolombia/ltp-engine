...
export const MODULE_DEFINITIONS: Record<ModuleId, ModuleConfig> = {
  ...
  trustBar: {
    id: 'trustBar',
    name: 'Trust Bar',
    description: 'Authority signals and credibility badges',
    required: false,
    defaultPosition: 1,
    repositionable: true,
    requiredFields: ['trust'],
  },
  vibe: {
    id: 'vibe',
    name: 'Vibe Gallery',
    description: 'Visual gallery showcasing atmosphere and experience',
    required: false,
    defaultPosition: 2,
    repositionable: true,
  ...
  route: {
    id: 'route',
    name: 'Route',
    description: 'Timeline or itinerary of experience stops',
    required: false,
    defaultPosition: 4,
    repositionable: true,
  ...
  localIntel: {
    id: 'localIntel',
    name: 'Local Intel',
    description: 'Neighborhood information and operating zone details',
    required: false,
    defaultPosition: 5,
    repositionable: true,
  ...
  rules: {
    id: 'rules',
    name: 'Rules',
    description: 'Rules of engagement and participant guidelines',
    required: false,
    defaultPosition: 6,
    repositionable: true,
